...
describe('concatenates 2 srings', () => {
  ...
  it('should throw an error', () => {
    expect(() => {concat( '', 'cd')}).to.throw('Empty strings can not be concatenated')
  });

  it('should throw an error', () => {
    expect(() => {concat( 'ab', '')}).to.throw('Empty strings can not be concatenated')
  });
})